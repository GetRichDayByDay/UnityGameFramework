...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class Entity : MonoBehaviour, IEntity
    {
        ...
        )
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnInit with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnRecycle()
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnRecycle with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnShow(object userData)
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnShow with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnHide(bool isShutdown, object userData)
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnHide with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnAttached(IEntity childEntity, object userData)
        {
            ...
            try
            {
                m_EntityLogic.OnAttached(
                    ((Entity)childEntity).Logic,
                    attachEntityInfo.ParentTransform,
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnAttached with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnDetached(IEntity childEntity, object userData)
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnDetached with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnAttachTo(IEntity parentEntity, object userData)
        {
            ...
            try
            {
                m_EntityLogic.OnAttachTo(
                    ((Entity)parentEntity).Logic,
                    attachEntityInfo.ParentTransform,
                    attachEntityInfo.UserData
                );
            }
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnAttachTo with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnDetachFrom(IEntity parentEntity, object userData)
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnDetachFrom with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
        ...
        public void OnUpdate(float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Log.Error(
                    "Entity '[{0}]{1}' OnUpdate with exception '{2}'.",
                    m_Id,
                    m_EntityAssetName,
                    exception
                );
